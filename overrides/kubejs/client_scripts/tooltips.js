ItemEvents.tooltip(event => {
	...
	event.add('kubejs:ingot_thousand_metals', Text.of('§7§oContains a mixture of many alloys and materials unknown to you. This material is full of secrets that will perhaps never be understood...').color('#FFFFFF')); 
